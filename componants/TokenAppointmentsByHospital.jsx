...
import DatatokenAppointments from './DatatokenAppointments';

const windowWidth = Dimensions.get('window').width;
const windowHeight = Dimensions.get('window').height;

const TokenAppointmentsByHospital = () => {
...
<ScrollView automaticallyAdjustKeyboardInsets={true}>
  ...
  {
   isdata && data ? 
       <DatatokenAppointments values={values}/>
    :
    data  ?
     <View>
...
export default TokenAppointmentsByHospital
