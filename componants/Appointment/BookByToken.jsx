import {
  ...
  const getAvailableSlots = async () => {
    try {
        ...
        const respond = await axiosClient.get(
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        console.log(inputValue,selecteddate?.currentDate,time)
        ...
        <ScrollView keyboardShouldPersistTaps="always">
          ...
          <View style={styles().formdata}>
            <TextInput
              ...
              placeholder="name"
              editable={inputValue?.AppointmentTime ? true :false}
