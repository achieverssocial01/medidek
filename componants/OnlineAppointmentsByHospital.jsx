import { Button, StyleSheet, Text, View, FlatList, TouchableOpacity, KeyboardAvoidingView, ScrollView, Dimensions, ActivityIndicator } from 'react-native'
import React, { useState, useEffect, useContext } from 'react'
import { Dropdown } from 'react-native-element-dropdown';
import moment from 'moment';
import UserContext from './Context/userContext';
import { axiosClient } from './utils/axiosClient';
import DataOnlineAppointments from './DataOnlineAppointments';

const windowWidth = Dimensions.get('window').width;
const windowHeight = Dimensions.get('window').height;

const OnlineAppointmentsByHospital = () => {
...
export default OnlineAppointmentsByHospital
