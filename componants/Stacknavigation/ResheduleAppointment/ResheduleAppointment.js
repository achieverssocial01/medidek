...
const RescheduleAppointment = ({ route }) => {
    ...
    const [appointment, setappointtment] = useState({ patientName: user[0]?.name, phoneNumber: user[0]?.phone, gender: "male", appointmentDate: "", appointmentTime: "", doctorsId: "r", hospitalId: "", updatedEmailAddress: user[0]?.email, userId: user[0]?._id, doctorsName: doctordata.nameOfTheDoctor })
