...
const EditDoctorByHospital = () => {
  ...
  const savechanges = async () => {
    ...
    formdata.append("nameOfTheDoctor", userAccount?.nameOfTheDoctor)
    ...
    >
      <ScrollView automaticallyAdjustKeyboardInsets={true}>
        <View style={{ paddingTop: 10, paddingHorizontal: 16, backgroundColor: "#FFFFFF" }}>
          ...
          <View style={{ borderWidth: 1, borderColor: "#D9D9D9", borderRadius: 6, paddingHorizontal: 20, paddingVertical: 10, justifyContent: "space-evenly", gap: 5 , backgroundColor:'#DCE3F6'}}>
...
export default EditDoctorByHospital
