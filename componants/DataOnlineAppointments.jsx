...
const DataOnlineAppointments = () => {
    ...
    return (
        ...
        <View style={{ gap: 15 }}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("EditOnlineAppointmentsByHospital")} style={{ backgroundColor: '#1F51C6', height: 50, borderRadius: 25, justifyContent: "center", margin: 20 }}>
...
export default DataOnlineAppointments
